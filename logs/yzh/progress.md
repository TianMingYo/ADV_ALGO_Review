...
* 在 ChatGPT 辅助下整理初读时遇到的不理解的问题。

## 2026-07-18
* 初始化 review 的 tex 仓库，准备开始 review 写作。

## 2026-07-19
* 草拟了 section 06 的核心内容，并在 ChatGPT 辅助下对文本内容进行打磨与补充。ChatGPT 的所有修改建议均在 ai-usage.md 中记录。
* 上传了修改后的版本，等全文基本定稿后再进行打磨优化。

## 2026-07-20
* 草拟了 section 07 的核心内容，并在 ChatGPT 辅助下对文本内容进行打磨与补充。ChatGPT 的所有修改建议均在 ai-usage.md 中记录。
* 上传了修改后的版本，等全文基本定稿后再进行打磨优化。

## 2026-07-24
* review section 01~05，撰写全文的conclusion部分。
* 草拟了 section 08 的核心内容，并在 ChatGPT 辅助下对文本内容进行打磨与补充。ChatGPT 的所有修改建议均在 ai-usage.md 中记录。
* 基本定稿，准备后续继续打磨文章的细节。